...
def compute_macro_f_beta(
    ...
    """Computes Macro-Averaged F_beta score across all S1 entities."""
    beta_sq = beta ** 2
    f_scores = []
...
def train_reranker_model(
    ...
    """Trains CatBoost classifier on candidate pair features."""
...
def optimize_f05_threshold(
    ...
    """Grid-searches decision threshold to maximize Macro F_0.5 score."""
...
def generate_matching_results(
    ...
    """Applies optimal probability threshold and exports matching_results.tsv."""
...
def validate_submission_files(
    ...
    """Calls competition helper script utils/validate_submission.py to check outputs."""
